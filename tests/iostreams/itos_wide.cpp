...
TEMPLATE_TEST_CASE("itos (base2) unsigned|signed int(8|16) wchar_t", "[unsigned|signed][int(8|16)][base2][wide]", int8_t, uint8_t, int16_t, uint16_t)
{
    using namespace wide;

    std::wstring desired, result;
...
TEMPLATE_TEST_CASE("itos (base2) signed int(32|64) wchar_t", "[signed int][32|64][base2][wide]", int32_t, int64_t)
{
    using namespace wide;
...
TEMPLATE_TEST_CASE("itos (base2) unsigned int(32|64) wchar_t", "[unsigned int(32|64)][base2][wide]", uint32_t, uint64_t)
{
    using namespace wide;
...
TEMPLATE_TEST_CASE("itos (base10) unsigned|signed int(8|16) wchar_t", "[unsigned|signed int(8|16)][base10][wide]", int8_t, uint8_t, int16_t, uint16_t)
{
    using namespace wide;
...
TEMPLATE_TEST_CASE("itos (base10) signed int(32|64) wchar_t", "[signed int(32|64)][base10][wide]", int32_t, int64_t)
{
    using namespace wide;
...
TEMPLATE_TEST_CASE("itos (base10) unsigned int(32|64) wchar_t", "[unsigned int][32|64][base10][wide]", uint32_t, uint64_t)
{
    using namespace wide;
...
TEMPLATE_TEST_CASE("itos spec p10 (base10) signed int(32|64) wchar_t", "[spec][signed int][32|64][base10][wide]", int32_t, int64_t)
{
    using namespace wide;
